...
class CreateTransparentPngUseCase {
  ...
  Future<Uint8List> createFromImages(File image1, File image2,
      {int threshold = 30}) async {
    // 透過PNG生成
  ...
  /// 実際の保存は行いません。
  Future<Uint8List> previewTransparentPng(File image1, File image2,
      {int threshold = 30}) async {
    return await transparentPngRepository.previewTransparentPng(image1, image2,
        threshold: threshold);
  }
}
